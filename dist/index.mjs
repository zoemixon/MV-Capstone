  ...
  useEffect(() => {
    ...
    function onAtomDoubleClick(event) {
      ...
      if (atomHit) {
        ...
        selectedAtom.material.emissive = new THREE.Color(16776960);
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("div", { style: { position: "relative", width: "100%", height: "100%" }, children: /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("div", { id: "elementColors", ref: elementColorRef, style: {
            pointerEvents: "auto",
            padding: "8px",
            maxHeight: "200px",
            overflowY: "auto",
          ...
          /* @__PURE__ */ jsx("div", { id: "bondLabels", ref: bondLabelRef, style: {
            pointerEvents: "auto",
            padding: "8px",
            maxHeight: "200px",
            overflowY: "auto",
          ...
          /* @__PURE__ */ jsx("div", { id: "atomLabels", ref: atomLabelRef, style: {
            pointerEvents: "auto",
            padding: "8px",
            maxHeight: "200px",
            overflowY: "auto",
